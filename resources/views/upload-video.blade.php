                        ...
                        <div class="row ">
                                 <div class="col-md-12">
                                        <div id="upload-container" class="text-center">
                                            <button id="browseFile" class="btn btn-primary">اختر فديو</button>
                                        </div>
                                        ...
                                        <div class="card-footer p-2" style="display: none">
                                            <input type="hidden" id="videoUrlPreview" name="videoUrl">
...
<script type="text/javascript">
    ...
    let resumable = new Resumable({
        ...
        fileType: ['mp4'],
        chunkSize: 15*1024*1024, // default is 1*1024*1024, this should be less than your maximum limit in php.ini
        headers: {
    ...
    resumable.on('fileSuccess', function (file, response) { // trigger when file upload complete
        ...
        $('#videoUrlPreview').val(response.filename);
