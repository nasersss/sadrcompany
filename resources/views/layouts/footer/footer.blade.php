    ...
    <div class="container">
        <div class="content ">
            <div class="item logofooter">
                <a href="{{ route('index') }}"><img src="{{ asset('assets/img/logo2.png') }}"
...
<div class=" copyright text-center bg-dark text-white py-2">
    ...
    <p class="font-rale font-size-14">Copyrights sadrcompany {{ now()->year }} &copy;. Desing By <br> <a
            href="https://goupdev.net" class="second-c">goup dev</a></p>
</div>
