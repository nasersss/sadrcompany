<nav class="navbar navbar-expand-lg navbar-light main-Bg navbar-my  pl-5 pr-5">
    <div class="container-fluid">
        <div>
            <a class="navbar-brand" href="{{ route('index') }}"><img src="{{ asset('assets/img/logo/Logo2.png') }}"
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <div
                class="px-5  d-flex flex-column align-items-start  flex-lg-row align-items-lg-center  justify-content-between w-100">
                    ...
                    <div class="rounded-circle" style=" height: 40px; width: 40px; border: 4px solid #b59276;">
                        ...
                        <ul class="dropdown-menu text-end nav-en nav-ar main-bg rounded-0"
                            ...
                            "
                                ...
                                <i class="mdi mdi-application-settings me-1"></i> لوحة التحكم</a>
                            <a href="{{ route('logout') }}"
