                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="email" id="emailaddress" required=""
                                    placeholder="ادخل بريدك الاكتروني" name="email" value="{{ old('email') }}"
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="password" id="password" placeholder="ادخل كلمة المرور"
                                ...
                                @enderror
                                <a href="{{ route('password.request') }}" class="text-muted float-end"><small>هل نسيت كلمة
                                        المرور؟</small></a>
                            </div>
                            ...
                            <div class="d-grid mb-0 text-center">
                                <button class="btn btn-primary text-light" type="submit"><i class="mdi mdi-login"></i>
                                    تسجيل الدخول </button>
                            </div>
                        ...
                        <div class="text-center mt-4">
                            ...
                            @if (Route::has('password.request'))
                                ...
                                <p class="text-muted mt-3">لا تمتلك اي حساب قم بانشاء حسابك الان ؟ <a
                                        href="{{ route('register') }}" class="text-muted ms-1"><b>انشاء حساب</b></a></p>
                            @endif
                            {{-- </footer> --}}
                        </form>
                        <!-- end form-->
