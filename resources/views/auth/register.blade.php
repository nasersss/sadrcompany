            ...
            <div class="auth-fluid-form-box">
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="mb-1">
                                ...
                                <input class="form-control" type="text" id="emailaddress" name="name"
                                    ...
                                    placeholder=" ادخل اسم المستخدم بك">
                                @error('name')
                            ...
                            <div class="mb-1">
                                ...
                                <input class="form-control" type="password" name="password_confirmation" required
                                    autocomplete="new-password" id="password" placeholder="تاكيد كلمة المرور ">
                            </div>
                            <div class="mb-1">
                        ...
                        <p class="text-muted mt-3">هل تمتلك حساب بالفعل سجل دخولك الان <a href="{{ route('login') }}"
                                class="text-muted ms-1"><b>تسجيل دخول</b></a></p>
                        {{-- </footer> --}}
