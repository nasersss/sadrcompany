                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <div class="avatar-lg">
                                        ...
                                        <img  src="@isset($user->profile->image){{$user->profile->image}} @else /images/users/defaultImage.png @endisset"  alt="" class="rounded-circle img-thumbnail" style="width:80px;height:80px ;">
                                    </div>
                                </div>
                                <div class="col">
                                    <div>
        ...
        <div class="col-xl-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div>
                        <p class="text-muted"><strong>اسم المستخدم :</strong> <span class="ms-2">@isset($user->name){{$user->name}}@endisset</span></p>

                        <p class="text-muted"><strong>اسم الكامل بالعربي :</strong> <span class="ms-2">@isset($user->profile->ar_full_name){{$user->profile->ar_full_name}}@endisset</span></p>

                        <p class="text-muted"><strong>اسم الكامل بالانجليزي :</strong> <span class="ms-2">@isset($user->profile->en_full_name){{$user->profile->en_full_name}}@endisset</span></p>
                        ...
                        <p class="text-muted"><strong>الوصف :</strong> <span class="ms-2">{{$user->trainer->description}}</span></p>
                        @endisset
