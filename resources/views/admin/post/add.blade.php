...
<div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">إضافة مقال </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('posts_save') }}" method="post" enctype="multipart/form-data" class=" form-disable">
                                @csrf
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane " id="category-content" >
                                        <div class="form-group pt-2">
                                            ...
                                            <select name="categoryId" id="" class="form-control" required>
                                                <option selected disabled>اختر احد اصناف المقالات</option>
                                    ...
                                    <div class="tab-pane " id="ar-content">
                                        ...
                                        <div class="form-group pt-2">
                                            ...
                                            <textarea name="body_ar" class="form-control">{{ old('body_ar') }}</textarea>
                                            @error('body')<span class="text-danger">{{ $message }}</span>@enderror
                                        </div>
                                    </div>
                                ...
                                <div class="form-group pt-2">
                                    <button type="submit" name="submit" class="btn btn-primary form-btn-disable">إضافة المقال </button>
                                </div>
                            </form>
